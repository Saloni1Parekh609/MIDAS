# -*- coding: utf-8 -*-
"""Point2_Finetuning.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1lUlsxpcemxt9WPpvQ3wMabY6MGVQOG2v
...
trainset = datasets.MNIST('path_to/MIDAS/Point2/MNIST', download=True, train=True, transform=img_transform)
testset = datasets.MNIST('path_to/MIDAS/Point2/MNIST', download=True, train=False, transform=img_transform)
...
checkpoint = torch.load("path_to/MIDAS/Point2/pretrained_model2.pt")
...
if __name__ == '__main__':
    ...
    print("Model Loaded and Created...")
